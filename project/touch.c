...
#define TS_XP_PIN               GPIO_PIN_1//U
#define TS_YP_PIN               GPIO_PIN_0//R

#define TS_N_PERIPH             SYSCTL_PERIPH_GPIOE
#define TS_N_BASE               GPIO_PORTE_BASE

#define TS_XN_PIN               GPIO_PIN_2//L
#define TS_YN_PIN               GPIO_PIN_3//D
...
const int32_t g_lTouchParameters[NUM_TOUCH_PARAM_SETS][NUM_TOUCH_PARAMS] =
{
    ...
    //
    {
	   ...
	   304896,	//   86784,          // M0
	   384,	// -1536,          // M1
	   -210986016,	//-17357952,      // M2
	   -840,		//-144,           // M3
	   -297288,		//-78576,         // M4
	   959297880,	// 69995856,       // M5
	   2682399,		//201804,         // M6
	/*
	   293504,	//   86784,          // M0
	   -8832,	// -1536,          // M1
	   -1174723200,	//-17357952,      // M2
	   -10248,		//-144,           // M3
	   -2616,		//-78576,         // M4
	   50604600,	// 69995856,       // M5
	   25400,		//201804,         // M6
*/
#endif
#ifdef PORTRAIT_FLIP
